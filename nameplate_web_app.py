...
.app-header{{position:sticky;top:0;z-index:50;background:white;border-bottom:1px solid #dbe2ea;box-shadow:0 8px 22px rgba(15,29,36,.06)}}
...
</style></head><body><header class="app-header"><div class="app-header-inner"><div class="app-logo">GM</div><div><div class="app-title">{esc(title)}</div><div class="app-subtitle">Refrigerator door gasket identification</div></div></div></header><main>{body}</main>
